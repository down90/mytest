...
<body>
	...
	<%
		...
		//[3] 쿠키 저장		//response 객체의 add 메서드이다!!!!!!!!!!!!
		response.addCookie(ck1);
		
		//두번째 쿠키
		Cookie ck2=new Cookie("age","20");
		//생성자 안에 내용이 바뀌면 객체가 새로 생기고 최대수명도 다시 생기지만 생성자 안의 내용이 바뀌지 않으면 그대로 유지된다
		ck2.setMaxAge(30*60);	//30qns
		ck2.setPath("/");	//경로 설정 : 설정한 경로 및 그 하위 경로에 대해서 쿠키 전달 즉, /herbmall 과 같음
